...
task main()
{
	...
	int slowSpeed;
	normalSpeed = 80;					// Initailize te Varible
	slowSpeed = 65;
...
if( SensorValue[leftEncoder] == SensorValue[rightEncoder])
{
	...
	SensorValue[rightEncoder] = 0;			// Move Forward https://www.dropbox.com/s/cgut384zcral4ow/Webinar%20Recordings.docx?dl=0
	SensorValue[leftEncoder] = 0;
		while(SensorValue[rightEncoder] < 1300)
{
	motor [rightMotor] = 63;
	motor [leftMotor] = 63;}
