...
) // Parameters control the Number value or what have you of what you want to run in your robot task main with your fuction
...
void turnpointright(int encoderCount)
{
	...
	SensorValue[rightEncoder] = 0;
	SensorValue[leftEncoder] = 0;
	while(SensorValue[leftEncoder] < 455)    //Turn Right
	{
