...
#pragma config(Motor,  port2,           armLowLeft,    tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port3,           armLowRight,   tmotorVex269_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           armHighLeft,   tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port5,           armHighRight,  tmotorVex269_MC29, openLoop, reversed)
